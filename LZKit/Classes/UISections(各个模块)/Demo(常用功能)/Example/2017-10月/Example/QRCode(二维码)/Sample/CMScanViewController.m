...
@interface CMScanViewController ()
...
- (void)drawBottomItems
{
    ...
    [_btnFlash setImage:[UIImage imageNamed:@"LBXScan.bundle/qrcode_scan_btn_flash_nor"] forState:UIControlStateNormal];
    ...
    [_btnPhoto setImage:[UIImage imageNamed:@"LBXScan.bundle/qrcode_scan_btn_photo_nor"] forState:UIControlStateNormal];
    [_btnPhoto setImage:[UIImage imageNamed:@"LBXScan.bundle/qrcode_scan_btn_photo_down"] forState:UIControlStateHighlighted];
    [_btnPhoto addTarget:self action:@selector(openPhoto) forControlEvents:UIControlEventTouchUpInside];
    
    self.btnMyQR = [[UIButton alloc]init];
    _btnMyQR.bounds = _btnFlash.bounds;
    _btnMyQR.center = CGPointMake(CGRectGetWidth(_bottomItemsView.frame) * 3/4, CGRectGetHeight(_bottomItemsView.frame)/2);
    [_btnMyQR setImage:[UIImage imageNamed:@"LBXScan.bundle/qrcode_scan_btn_myqrcode_nor"] forState:UIControlStateNormal];
    [_btnMyQR setImage:[UIImage imageNamed:@"LBXScan.bundle/qrcode_scan_btn_myqrcode_down"] forState:UIControlStateHighlighted];
...
//    [LBXAlertAction showAlertWithTitle:@"提示" msg:str chooseBlock:nil buttonsStatement:@"知道了",nil];
    [[LZAlertView sharedInstance] showAlertController:self title:@"提示" message:str cancelTitle:@"知道了" actionBlock:^(NSInteger buttonTag) {
...
//    } buttonsStatement:@"知道了",nil];
    ...
    [[LZAlertView sharedInstance] showAlertController:self title:@"扫码内容" message:strResult cancelTitle:@"知道了" actionBlock:^(NSInteger buttonTag) {
        //点击完，继续扫码
        [weakSelf reStartDevice];
    } otherButtonTitles:nil];
...
- (void)openOrCloseFlash
{
    ...
    if (self.isOpenFlash)
    {
        [_btnFlash setImage:[UIImage imageNamed:@"LBXScan.bundle/qrcode_scan_btn_flash_down"] forState:UIControlStateNormal];
    }
    else
        [_btnFlash setImage:[UIImage imageNamed:@"LBXScan.bundle/qrcode_scan_btn_flash_nor"] forState:UIControlStateNormal];
}
...
- (void)myQRCode
{
    CMMyQRCodeViewController *vc = [CMMyQRCodeViewController new];
    [self.navigationController pushViewController:vc animated:YES];
}
