...
@interface CMMyQRCodeViewController ()
...
@implementation CMMyQRCodeViewController
...
- (void)newCodeChooose
{
    ...
    [[LZAlertView sharedInstance] showActionSheetController:self title:nil message:nil cancelTitle:@"取消" destructive:nil actionBlock:^(NSInteger buttonTag) {
    ...
    } otherButtonTitles:@"二维码+logo",@"二维码上色",@"二维码前景颜色+背景颜色",@"商品条形码",@"code93(支付宝付款条形码)",nil];
