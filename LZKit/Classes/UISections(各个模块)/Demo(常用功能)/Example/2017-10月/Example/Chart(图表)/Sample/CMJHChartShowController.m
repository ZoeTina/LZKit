...
- (void)showFirstQuardrant{
    ...
    /* Line Chart colors */
    lineChart.valueLineColorArr =@[kColorWithRGB(12, 133, 239)];
    ...
    lineChart.gradientColor = @[ kColorWithRGB(12, 133, 239)];
    lineChart.touchFlowLineColor = kColorWithRGB(12, 133, 239);
