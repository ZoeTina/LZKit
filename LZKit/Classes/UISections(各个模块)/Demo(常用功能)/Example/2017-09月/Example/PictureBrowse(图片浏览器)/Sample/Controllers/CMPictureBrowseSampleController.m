...
- (void)initUI {
    ...
    _collectionView = [[UICollectionView alloc]initWithFrame:CGRectMake(0, btn.lz_bottom, kScreenWidth, kScreenHeight- btn.lz_bottom) collectionViewLayout:flowLayout];
