...
//        if (DEF_iOS9_LATER) {
//            
//            [[LZAlertView alloc] showAlertController:self title:@"3D Touch未开启" message:@"请在iPhone的\"设置>通用>辅助功能>3D Touch\"选项中,开启3D Touch功能." cancelTitle:@"确定" actionBlock:^(NSInteger buttonTag) {
//                
