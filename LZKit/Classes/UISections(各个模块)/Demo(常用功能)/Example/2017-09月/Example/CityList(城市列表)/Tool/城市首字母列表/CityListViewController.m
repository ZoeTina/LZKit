...
- (void)viewDidLoad
{
    ...
    CGRect frame = CGRectMake(0,searchView.lz_y+searchView.lz_height, self.view.lz_width, self.view.lz_height-64);
    _tableView = [UITableView lz_initWithFrame:frame
...
-(void)getCityData
{
    NSString *path=[[NSBundle mainBundle] pathForResource:@"CMCityList.bundle/citydict" ofType:@"plist"];
