...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    switch (indexPath.row) {
        case 0:
            [[LZAlertView sharedInstance] showAlertController:self title:@"提示" message:@"这是一个测试消息" cancelTitle:@"取消" actionBlock:^(NSInteger buttonTag) {
                switch (buttonTag) {
                    case 0:
                        //do something
                        break;
            ...
            break;
        case 1:
            [[LZAlertView sharedInstance] showActionSheetController:self title:@"提示" message:@"这是一个测试消息" cancelTitle:@"取消" destructive:@"滚犊子" actionBlock:^(NSInteger buttonTag) {
                switch (buttonTag) {
                    case 0:
                        //do something
                        break;
