...
static NSString *CellIdentifier = @"LZMineViewController";
static NSString *BaseTableViewCell = @"LZBaseTableViewCell";

@interface LZMineViewController ()<UITableViewDelegate,UITableViewDataSource>
...
- (void)viewDidLoad {
    ...
    dispatch_after(popTime, dispatch_get_main_queue(), ^(void){
        ...
        [self addCell:@"聊天键盘" class:@"LZMessageViewController"];
